package com.hm.filestreamoperationneedclose;
...
//        linesTest();
    ...
    private static void readLargeFileWrong() throws IOException {
        log.info("lines {}", Files.readAllLines(Paths.get("E:\\big_data\\code\\hm-mall\\hm_mall\\hm-mistakes\\src\\main\\resources\\large.txt")).size());
    }
