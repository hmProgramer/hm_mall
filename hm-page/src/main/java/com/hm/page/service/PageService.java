package com.hm.page.service;

import com.hm.common.enums.ExceptionEnums;
import com.hm.common.exception.HmException;
import com.hm.item.pojo.*;

import com.hm.page.client.BrandClient;
import com.hm.page.client.CategoryClient;
import com.hm.page.client.GoodsClient;
import com.hm.page.client.SpecClient;
...
public class PageService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        if (!spu.getSaleable()) {
            throw new HmException(ExceptionEnums.GOODS_NOT_SALEABLE);
        }
